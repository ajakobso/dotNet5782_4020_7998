...
namespace Dal
{
    public class DataSource
    {
        ...
        {
            Random r = new();
            Config.BaseStations.Add(new BaseStation { Id = 101, Name = "station1", ChargeSlots = 3, AvailableChargeSlots = 3, Longitude = 35.139781663410915/*(r.NextDouble() * (DataSource.Config.LongitudeRange[1] - DataSource.Config.LongitudeRange[0])) + DataSource.Config.LongitudeRange[0]*/, Lattitude = 31.811342468566419/*(r.NextDouble() * (DataSource.Config.LattitudeRange[1] - DataSource.Config.LattitudeRange[0])) + DataSource.Config.LattitudeRange[0]*/ });//initializing stations around Jerusalem
            Config.BaseStations.Add(new BaseStation { Id = 102, Name = "station2", ChargeSlots = 5, AvailableChargeSlots = 5, Longitude = 35.129248402818405/*(r.NextDouble() * (DataSource.Config.LongitudeRange[1] - DataSource.Config.LongitudeRange[0])) + DataSource.Config.LongitudeRange[0]*/, Lattitude = 31.751978124616194/*(r.NextDouble() * (DataSource.Config.LattitudeRange[1] - DataSource.Config.LattitudeRange[0])) + DataSource.Config.LattitudeRange[0]*/ });
            ...
            Config.Customers.Add(new Customer { Id = 306894751, Name = "Taylor", Phone = "0548489651", Longitude = (r.NextDouble() * (DataSource.Config.LongitudeRange[1] - DataSource.Config.LongitudeRange[0])) + DataSource.Config.LongitudeRange[0], Lattitude = (r.NextDouble() * (DataSource.Config.LattitudeRange[1] - DataSource.Config.LattitudeRange[0])) + DataSource.Config.LattitudeRange[0] });
