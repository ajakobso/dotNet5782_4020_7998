...
namespace PL.PO
{
    public class BaseStationForList : DependencyObject
    {
        ...
        static readonly DependencyProperty DInChargeListProperty = DependencyProperty.Register("Drone in charge", typeof(ObservableCollection<DroneInCharge>), typeof(BaseStationForList));
        ...
        public ObservableCollection<DroneInCharge> DInChargeList { get => (ObservableCollection<DroneInCharge>)GetValue(DInChargeListProperty); set => SetValue(DInChargeListProperty, value); }
    }
}
