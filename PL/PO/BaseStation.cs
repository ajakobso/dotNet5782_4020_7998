...
namespace PL.PO
{
    public class BaseStation: DependencyObject
    {
        ...
        static readonly DependencyProperty DInChargeListProperty = DependencyProperty.Register("Drone in charge", typeof(ObservableCollection<DroneInCharge>), typeof(BaseStation));      
